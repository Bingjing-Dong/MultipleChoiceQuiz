...
public class Questions implements Parcelable {
    //to save difficulty level
    public static final String difficultEasy = "Easy";
    public static final String difficultMedium = "Medium";
    public static final String difficultHard = "Hard";
    ...
    public static String[] getAllDifficultyLevels() {
        return new String[] {
                difficultEasy, difficultMedium, difficultHard
        };
    }
}
